...
foreach my $groupname (@groups){
	...
	my$errmatxrix=`nice perl auto_find_circ/matrixmaker-V3_A.pl $groupname/allsites_bedgroup_$groupname.csv $groupname/allcircs_matrixout.txt`;
	my$matrtmaker=`perl auto_find_circ/matrixtwo.pl $groupname/allcircs_matrixout.txt $groupname/allc_matrixtwo.tsv`;
...
my$erralm1=`nice perl auto_find_circ/matrixmaker-V3_A.pl $ndir/$ndir.allbeds.find_circ.out $ndir/allsamples_matrix.find_circ.mat1`;
my$err_mat2=`perl auto_find_circ/matrixtwo.pl $ndir/allsamples_matrix.find_circ.mat1 $ndir/allsamples_m_heatmap.find_circ.mat2`;
